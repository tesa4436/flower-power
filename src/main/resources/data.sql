...
values (1, 1, 0, 'Hiacintas',          3.15,   'Tai yra hiacintas!'),
       (2, 0, 0, 'Rožė',               2.5,    'Tai yra rožė!'),
       (3, 0, 0, 'Pelargonija',        3.55,   'Tai yra pelargonija!'),
       ...
       (7, 0, 1, 'Rožių puokštė',      35.25,  'Tai yra rožių puokštė!'),
       (8, 25, 1, 'Pelargonijų puokštė',40.0,   'Tai yra pelargonijų puokštė!'),
       (9, 255, 1, 'Tulpių puokštė',     50.5,   'Tai tulpių hiacintų puokštė!'),
       (10, 0, 1, 'Orchidėjų puokštė', 25.0,   'Tai yra orchidėjų puokštė!');
