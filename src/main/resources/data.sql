...
values (1, 1, 0, 'Hiacintas',          3.15,   'Tai yra hiacintas!', 1, 1),
       (2, 0, 0, 'Rožė',               2.5,    'Tai yra rožė!', 1, NULL),
       (3, 0, 0, 'Pelargonija',        3.55,   'Tai yra pelargonija!', 1, NULL),
       (4, 25, 0, 'Tulpė',              3.1,    'Tai yra tulpė!', 1, NULL),
       (5, 25, 0, 'Orchidėja',          4.5,    'Tai yra orchidėja!', 1, NULL),
       (6, 25, 1, 'Hiacintų puokštė',   30.0,   'Tai yra hiacintų puokštė!', 1, NULL),
       (7, 0, 1, 'Rožių puokštė',      35.25,  'Tai yra rožių puokštė!', 1, NULL),
       (8, 25, 1, 'Pelargonijų puokštė',40.0,   'Tai yra pelargonijų puokštė!', 1, NULL),
       (9, 255, 1, 'Tulpių puokštė',     50.5,   'Tai tulpių hiacintų puokštė!', 1, NULL),
       (10, 0, 1, 'Orchidėjų puokštė', 25.0,   'Tai yra orchidėjų puokštė!', 1, NULL);
